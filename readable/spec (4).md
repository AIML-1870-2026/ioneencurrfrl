...
|                   |                           |               |
+-------------------+---------------------------+---------------+
|         Contrast Ratio Display | Luminosity Values            |
+---------------------------------------------------------------+
```
...
- **Bottom bar:** Contrast ratio display and luminosity values for both colors
...
- When a color blindness simulation is active, the displayed colors are transformed accordingly (see Stretch Feature below)
